package org.com.stocknote.domain.stockDoc.controller;
...
import org.com.stocknote.domain.stockDoc.service.StockDocService;
...
public class SearchDocController {
  ...
  public GlobalResponse<List<StockInfoResponse>> searchStocks(
    ...
    List<Stock> stockList = stockDocService.searchStocks(keyword);
